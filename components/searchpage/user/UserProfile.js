...
const UserProfile = ({name, date, username, imageURL}) => {
    return (
        <>
            <div
                className=" flex flex-col md:flex-row w-full   items-center space-y-6  md:justify-evenly md:space-x-6">
                {imageURL ? (
                ...
                <div
                    className="flex items-center w-full justify-around space-x-6 px-2 text-center md:text-left md:flex-1 md:items-start md:justify-between">
